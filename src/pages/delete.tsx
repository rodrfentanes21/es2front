  ...
  return (
    <div className="w-full lg:w-screen h-screen flex justify-center items-start">
      ...
      <section className=" flex flex-col justify-center items-center gap-2 w-full lg:w-screen h-screen">
        <form className="flex flex-col justify-start items-center gap-2 w-1/2 aspect-[2/1] py-10 border rounded-xl self-center">
          ...
          <input
            type="submit"
            value="Submit"
            className="w-32 bg-blue-400 hover:bg-sky-700 rounded-full text-white text-xl text-center"
          />
        </form>
        <div className="">
